...
VERSION_CODENAMES = [
    ...
    "Hooker",           # v4.47 -- John Lee Hooker, Delta-blues guitarist
                        ...
                        # (1917-2001)
    "Waters",           # v4.48 -- Muddy Waters, "the father of modern
    ...
    "Thunders",         # v4.53 -- Johnny Thunders, guitarist, New York
                        ...
                        # figure (1952-1991)
    "Chapin",           # v4.54 -- Harry Chapin, singer-songwriter,
    ...
    "Bramlett",         # v4.63 -- Delaney Bramlett, Delaney & Bonnie,
                        ...
                        # (1939-2008)
    "Wray",             # v4.64 -- Link Wray, guitarist, "Rumble" --
                        # a foundational influence on the power chord
                        # (1929-2005)
    "VanZant",          # v4.65 -- Ronnie Van Zant, frontman/founder,
                        # Lynyrd Skynyrd (1948-1977)
    "Ochs",             # v4.66 -- Phil Ochs, protest-folk-rock
    ...
    "Meisner",          # v4.71 -- Randy Meisner, founding bassist/
    ...
    "Prine",            # v4.77 -- John Prine, singer-songwriter
                        # (1946-2020)
    "Emerson",          # v4.78 -- Keith Emerson, keyboardist/co-founder,
                        # Emerson, Lake & Palmer (1944-2016)
    "Lake",             # v4.79 -- Greg Lake, singer/bassist/co-founder,
                        # Emerson, Lake & Palmer / King Crimson
                        # (1947-2016)
    "Smith",            # v4.80 -- Elliott Smith, singer-songwriter
                        # (1969-2003)
    "HoneymanScott",    # v4.81 -- James Honeyman-Scott, lead guitarist/
                        # co-founder, The Pretenders (1956-1982)
    "Hoon",             # v4.82 -- Shannon Hoon, singer/frontman, Blind
                        # Melon (1967-1995)
    "Barrett",          # v4.83 -- Syd Barrett, founding member/original
                        # frontman, Pink Floyd (1946-2006)
    "Ayers",            # v4.84 -- Kevin Ayers, singer/bassist, founding
    ...
    "McVie",            # v4.87 -- Christine McVie, singer/keyboardist
                        # of Fleetwood Mac ("Songbird", "Don't Stop")
                        # (1943-2022)
    "Lightfoot",        # v4.88 -- Gordon Lightfoot, folk-rock singer-
                        # songwriter ("Sundown", "If You Could Read My
                        # Mind") (1938-2023)
    "Slovak",           # v4.89 -- Hillel Slovak, original guitarist and
                        # founding member of Red Hot Chili Peppers
                        # (1962-1988)
    ...
    "Jordison",         # v4.93 -- Joey Jordison, co-founding drummer of
                        # Slipknot (1975-2021)
    ...
    "Pickett",          # v4.96 -- Wilson Pickett, soul singer ("In the
                        # Midnight Hour") (1941-2006)
    "Bopper",           # v4.97 -- The Big Bopper (J. P. Richardson), "Chantilly
                        # Lace" (1930-1959)
    "Nelson",           # v4.98 -- Ricky Nelson, "Hello Mary Lou" (1940-1985)
    "Wolf",             # v4.99 -- Howlin' Wolf (Chester Burnett), Chicago
